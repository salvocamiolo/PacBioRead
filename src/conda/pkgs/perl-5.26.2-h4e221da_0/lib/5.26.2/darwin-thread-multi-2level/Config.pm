...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.26.2/darwin-thread-multi-2level'),
    ...
    libpth => '/opt/concourse/worker/volumes/live/b133cba7-a5c8-4924-7b0b-1252abc8cd61/volume/perl_1527832193450/_build_env/bin/../lib/clang/4.0.1/lib /opt/MacOSX10.9.sdk/usr/lib',
    osname => 'darwin',
    osvers => '14.5.0',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.26.2'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.26.2/darwin-thread-multi-2level'),
