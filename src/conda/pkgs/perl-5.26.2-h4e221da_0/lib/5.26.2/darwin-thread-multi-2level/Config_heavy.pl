...
config_arg6='-Dldflags=-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/anaconda1anaconda2anaconda3/lib -L/opt/anaconda1anaconda2anaconda3/lib'
...
config_argc='9'
config_args='-de -Dprefix=/opt/anaconda1anaconda2anaconda3 -Dusethreads -Duserelocatableinc -Dcccdlflags=-fPIC -Dldflags=-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/anaconda1anaconda2anaconda3/lib -L/opt/anaconda1anaconda2anaconda3/lib -Ddefault_inc_excludes_dot=n -Dcc=x86_64-apple-darwin13.4.0-clang -Dsysroot=/opt/MacOSX10.9.sdk'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
ld_can_script='undef'
lddlflags='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/anaconda1anaconda2anaconda3/lib -L/opt/anaconda1anaconda2anaconda3/lib -mmacosx-version-min=10.9 -bundle -undefined dynamic_lookup --sysroot /opt/MacOSX10.9.sdk -fstack-protector-strong'
ldflags='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/anaconda1anaconda2anaconda3/lib -L/opt/anaconda1anaconda2anaconda3/lib -fstack-protector-strong'
...
ldflags_nolargefiles='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/anaconda1anaconda2anaconda3/lib -L/opt/anaconda1anaconda2anaconda3/lib -fstack-protector-strong'
